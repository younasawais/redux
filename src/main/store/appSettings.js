...
const libraryFiltered = {
  ...
  translation : ['transition1','transition2', 'transition3','transition4','transition5'],
  synonym     : ['synonym1','synonym2', 'synonym3','synonym4','synonym5'],
}
...
const reducer = (state = initialState, action) => {
  ...
  switch (action.type) {
    case 'STARTRANGE':
      return {...state, temp : action.payload[0]}//eslint-disable-next-line
      //return {...state, settings : [...state.settings, action.payload[0]]}//eslint-disable-next-line
      break;
    default:
      return state;
  }
