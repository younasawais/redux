...
class FilterWords extends React.Component{
  constructor(props){
    ...
    console.log('constructor',this.props.reducerLibraryFiltered);
  }

  componentWillMount(){
    console.log('componentWillMount',this.props);
    this.filterWordList(this.props);
  }
  ...
  componentWillReceiveProps(nextProps){
    ...
    const temp = {'different' : different, 'props' : this.props.reducerSettings, 'next' : nextProps.reducerSettings};
    console.log('componentWillReceiveProps',temp);
    if (different) {
      this.filterWordList();
    }
  }
  ...
  filterWordList(){
    ...
    //dispatch({type : 'FILTEREDLIBRARY', payload : {'filteredLibrary' : filteredLibrary}});
